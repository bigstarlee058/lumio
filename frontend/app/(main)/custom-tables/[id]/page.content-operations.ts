...
const content = {
  ...
  content: {
    paste: {
      ...
      headersToggle: t({ ru: 'Первая строка — заголовки', en: 'First row is headers', kk: 'Бірінші жол — тақырыптар' }),
      parsing: t({ ru: 'Подготовка превью...', en: 'Preparing preview...', kk: 'Алдын ала көру дайындалуда...' }),
      ...
      insertFailed: t({ ru: 'Не удалось добавить строки', en: 'Failed to add rows', kk: 'Жолдарды қосу мүмкін болмады' }),
      undoFailed: t({ ru: 'Не удалось отменить вставку', en: 'Failed to undo insert', kk: 'Қоюды болдырмау мүмкін болмады' }),
      moreRowsPrefix: t({ ru: 'И ещё ', en: 'And ', kk: 'Тағы ' }),
      moreRowsSuffix: t({ ru: ' строк', en: ' more rows', kk: ' жол' }),
      mappingTitle: t({ ru: 'Сопоставление колонок', en: 'Column mapping', kk: 'Бағандарды сәйкестендіру' }),
      ...
      missingColumnTitle: t({ ru: 'Укажите название новой колонки', en: 'Provide a name for the new column', kk: 'Жаңа баған атауын енгізіңіз' }),
    ...
    addRow: {
      ...
      failed: t({ ru: 'Не удалось добавить строку', en: 'Failed to add row', kk: 'Жол қосу мүмкін болмады' }),
    },
  },
