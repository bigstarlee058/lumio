        ...
        <div className="lumio-expense-drawer">
          ...
          <div className="lumio-expense-drawer__content">
            {currencyPickerOpen ? (
              ...
              <>
                <label style={{ display: 'flex', cursor: 'pointer', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderRadius: 0, border: '2px dashed', borderColor: 'color-mix(in srgb, var(--primary) 40%, transparent)', background: 'rgba(0,0,0,0.04)', padding: '48px 24px', textAlign: 'center' }}>
                  ...
                  <span style={{ marginTop: 24, display: 'inline-flex', borderRadius: 0, background: 'var(--primary)', padding: '10px 28px', fontSize: 14, fontWeight: 600, color: '#fff' }}>
                    Choose files
                  </span>
                  <input
                    ref={fileInputRef}
                ...
                <div style={{ display: 'flex', flex: 1, flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                  ...
                  <div style={{ margin: '0 auto', width: 290, maxWidth: '100%' }}>
                    ...
                    <button
                      ...
                      style={{ marginTop: 48, display: 'inline-flex', height: 64, width: '100%', alignItems: 'center', justifyContent: 'center', gap: 8, borderRadius: 0, border: '1px solid var(--border-color, #d7e2ef)', background: 'var(--muted)', padding: '0 24px', fontSize: 18, fontWeight: 600, color: 'var(--foreground)', cursor: 'pointer' }}
                    >
              ...
              <>
                <label style={{ position: 'relative', display: 'flex', cursor: 'pointer', alignItems: 'center', justifyContent: 'center', borderRadius: 0, border: '1px solid var(--border-color, #d7e2ef)', background: 'rgba(0,0,0,0.04)', padding: '32px 24px', textAlign: 'center' }}>
                  <FileText size={56} style={{ color: 'color-mix(in srgb, var(--muted-foreground) 60%, transparent)' }} />
                  <span style={{ position: 'absolute', left: '50%', top: '50%', display: 'flex', height: 40, width: 40, transform: 'translate(8px, 4px)', alignItems: 'center', justifyContent: 'center', borderRadius: '50%', background: 'var(--primary)', color: '#fff' }}>
                    <Plus size={20} />
                  </span>
                  <input
                    type="file"
                ...
                <div style={{ overflow: 'hidden', borderRadius: 0, border: '1px solid var(--border-color, #d7e2ef)', background: 'var(--card-bg, #fff)' }}>
                  <button
                    type="button"
            ...
            {files.length > 0 && !currencyPickerOpen ? (
              <div style={{ borderRadius: 0, border: '1px solid var(--border-color, #d7e2ef)', background: 'var(--card-bg, #fff)', padding: '12px' }}>
                ...
                <div style={{ marginTop: 8, display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {files.map(file => (
                    <div
                      ...
                      style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderRadius: 0, border: '1px solid var(--border-color, #d7e2ef)', padding: '8px 12px', fontSize: 14 }}
                    >
            ...
            {error ? (
              <div style={{ borderRadius: 0, border: '1px solid #fecaca', background: '#fff1f2', padding: '8px 12px', fontSize: 14, color: '#b91c1c' }}>
                {error}
              </div>
            ) : null}
          </div>
