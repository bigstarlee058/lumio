...
function SortBtn({ label, active, onClick }: SortBtnProps): React.JSX.Element {
  return (
    <button
      type="button"
      className={`lumio-view-page__sort-btn${active ? ' lumio-view-page__sort-btn--active' : ''}`}
      onClick={onClick}
    >
      {label}
    </button>
...
export function SpendOverTimeLeaderboard({
  rows,
  sortKey,
  onSortChange,
  onRowClick,
    ...
    <div className="lumio-view-page__leaderboard-card">
      ...
      <div className="lumio-view-page__table-wrap">
        <table className="lumio-view-page__table">
          <thead>
            <tr>
              <th>{columnLabels.period}</th>
              <th style={{ textAlign: 'right' }}>{columnLabels.operations}</th>
              <th style={{ textAlign: 'right' }}>{columnLabels.average}</th>
              <th style={{ textAlign: 'right' }}>{columnLabels.amount}</th>
              <th style={{ textAlign: 'right' }}>{columnLabels.lastOperation}</th>
            </tr>
          </thead>
          <tbody>
