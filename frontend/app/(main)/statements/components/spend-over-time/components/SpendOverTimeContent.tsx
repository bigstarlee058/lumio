      ...
      {viewType === 'calendar' ? (
        <SpendOverTimeCalendar
          ...
          labels={{
            ...
            emptyMonth: labels.calendarEmptyMonth,
            operations: labels.calendarOperations,
          }}
        />
      ) : (
        <>
          <SpendOverTimeCharts
            ...
            periodsChart={vm.periodsChart as object}
            chartTheme={chartTheme}
            trendTitle={labels.trendTitle}
            sourceSplitTitle={labels.sourceSplit}
            periodChartTitle={labels.periodChart}
          />
          <SpendOverTimeLeaderboard
            rows={vm.rows}
            sortKey={vm.sortKey}
            onSortChange={vm.setSortKey}
            onRowClick={vm.setSelectedPeriod}
