import type { TopSpenderAggregateRow, TopSpenderFlowType } from './top-spenders.utils';
...
export function buildTopSpendersBarChart(
  sortedRows: TopSpenderAggregateRow[],
...
export function buildTopSpendersSourceChart(
  totals: SourceTotals,
