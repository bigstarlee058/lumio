...
export function TopCategoriesSearchRow({ vm }: Props): JSX.Element {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <div style={{ width: 240 }}>
        <label htmlFor="top-categories-workspace-filter" style={{ position: 'absolute', width: 1, height: 1, overflow: 'hidden', clip: 'rect(0,0,0,0)', whiteSpace: 'nowrap' }}>{vm.labels.workspace}</label>
        <select
