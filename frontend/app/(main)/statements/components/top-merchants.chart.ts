import type { TopMerchantAggregateRow, TopMerchantFlowType } from './top-merchants.utils';
...
export function buildTopMerchantsBarChart(
  sortedRows: TopMerchantAggregateRow[],
...
export function buildTopMerchantsSourceChart(
  totals: SourceTotals,
