...
const content = {
  ...
  content: {
    ...
    googleRegisterFailed: t({
      ...
      ja: 'Googleでの登録に失敗しました。もう一度お試しください。',
      ko: 'Google로 회원가입에 실패했습니다. 다시 시도해 주세요.',
      hi: 'Google से साइन अप करने में विफल। कृपया पुनः प्रयास करें।',
      nl: 'Registratie met Google mislukt. Probeer het opnieuw.',
      sv: 'Det gick inte att registrera dig med Google. Försök igen.',
      vi: 'Đăng ký bằng Google thất bại. Vui lòng thử lại.',
      id: 'Gagal mendaftar dengan Google. Silakan coba lagi.',
    }),
    orLabel: t({
      ru: 'или',
      en: 'or',
