...
const content = {
  ...
  content: {
    ...
    googleLoginFailed: t({
      ...
      ja: 'Googleでのログインに失敗しました。もう一度お試しください。',
      ko: 'Google로 로그인에 실패했습니다. 다시 시도해 주세요.',
      hi: 'Google से साइन इन करने में विफल। कृपया पुनः प्रयास करें।',
      nl: 'Inloggen met Google mislukt. Probeer het opnieuw.',
      sv: 'Det gick inte att logga in med Google. Försök igen.',
      vi: 'Đăng nhập bằng Google thất bại. Vui lòng thử lại.',
