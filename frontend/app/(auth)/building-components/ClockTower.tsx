...
export const ClockTower = ({ delay, duration, w = 120, h = 300, ...pos }: BuildingProps): React.JSX.Element => (
  ...
  >
    ...
    <div style={{ width: 0, height: 0, borderLeft: `${w * 0.55}px solid transparent`, borderRight: `${w * 0.55}px solid transparent`, borderBottom: '60px solid rgba(255,255,255,0.1)', marginBottom: '-1px' }} />
    <ClockFaceBlock w={w} />
    <Block w={w} h={h}>
