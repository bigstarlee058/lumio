  ...
  return (
    <div className="lumio-pdf-preview-modal__header" ref={containerRef}>
      ...
      <div className="lumio-pdf-preview-modal__header-actions">
        <button type="button" onClick={onToggleMenu} className="lumio-pdf-preview-modal__menu-btn" aria-label="Open file menu">
          <MoreVertical size={24} strokeWidth={2.4} />
        </button>
        <button type="button" onClick={onClose} className="lumio-pdf-preview-modal__close-btn" aria-label="Close preview">
          <X size={33} strokeWidth={2.4} />
        </button>
      </div>
      {menuOpen && (
        <div className="lumio-pdf-preview-modal__dropdown-menu">
          <button type="button" onClick={onDownload} className="lumio-pdf-preview-modal__dropdown-item">
